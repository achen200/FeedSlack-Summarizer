...
export const File = (props) => {
	...
	useEffect(() => {
		setOriginalText(props.original);
		setSummaryText(props.summary);
	...
	function setLastFile(){
		...
		props.setCurrSummary(summaryText);
		props.setCurrOriginal(originalText);
	}

	return (
	<div className="file" onClick={()=>setLastFile()}>
